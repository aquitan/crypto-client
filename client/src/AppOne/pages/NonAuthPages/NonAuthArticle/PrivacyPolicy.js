                        ...
                        <LandingBlock classname='landingBlock'>
                            <ButtonCard theme={theme}>
                                <div className="article footer_links_page">
                                    ...
                                    <p className="article-text">Thank you for visiting {state.domainName}, a digital asset trading website,
                                        which is provided
                                        by {state.domainName}. By visiting, accessing, or using {state.domainName} and associated application
                                        program
                                        interface (“Site”), you consent to the policies and practices of our privacy policy (the
                                        “Privacy Policy”), so
                                        please read them carefully. This Privacy Policy explains how {state.domainName} uses your Personal
                                        Data (defined
                                    ...
                                    <p className="article-text">{state.domainName} collects, processes, and stores Personal Data collected from
                                        you via your
                                        ...
                                        as an IP address
                                        and a MAC number).</p>
                                    <p className="article-text">We collect information you provide during the {state.domainName} onboarding
                                        process, which may
                                    ...
                                    <p className="article-text">As outlined above, we may collect Personal Data from customers located in
                                        ...
                                        EEA and you
                                        decline to consent to such transfer, you will no longer be able to use {state.domainName} and our
                                        services. You
                                    ...
                                    <p className="article-text">{state.domainName} uses Personal Data to communicate with you and to
                                        administer, deliver,
                                        improve, and personalize the Service. {state.domainName} might also generate generic data out of
                                        any Personal Data
                                        we collect and use it for our own purposes. We may also use such data to communicate with you in
                                        relation to
                                        other products or services offered by {state.domainName} and/or its partners. We do not share your
                                        Personal Data
                                        with third parties (other than partners in connection with their services to {state.domainName})
                                        except where you
                                    ...
                                    <p className="article-text">To comply with government agencies, including regulators, law enforcement
                                        and/or justice
                                        departments;</p>
                                    <p className="article-text">To third parties who provide services to {state.domainName} (such as
                                        administration or
                                    ...
                                    <p className="article-text">You have the right to obtain a copy of your Personal Data upon request and
                                        ...
                                        legal purposes. For
                                        data access, correction, or deletion requests, please contact support@{state.domainName}.club with the subject
                                        “DATA INQUIRY”.
                                    </p>
                                    ...
                                    <p className="article-text">We may communicate company news, promotions, and information relating to our
                                        products and
                                        services provided by {state.domainName}. We may share Personal Data with third parties to help us
                                        with our
                                        marketing and promotional projects, or sending marketing communications. By using
                                        {state.domainName}, you accept
                                    ...
                                    <p className="article-text">Customers can opt out of these marketing communications at any moment. If
                                        you do not want to
                                        receive these communications, please send an email to support@{state.domainName}.club</p>
                                    ...
                                    <p className="article-text">We endeavor to protect {state.domainName} and you from unauthorized access,
                                        alteration,
                                        disclosure, or destruction of Personal Data we collect and store. We take various measures to
                                        ensure information
                                        security, including encryption of the {state.domainName} communications with SSL; required
                                        two-factor
                                    ...
                                    <h4 className="article-subtitle">10. CONTACTING {state.domainName} ABOUT PRIVACY QUESTIONS OR CONCERNS</h4>
                                    <p className="article-text">If you have any questions about this Privacy Policy or the use of your
                                        Personal Data, please
                                        contact us by sending an email to the following address support@{state.fullDomainName} with the subject
                                        “PRIVACY REQUEST”.
                                    </p>
