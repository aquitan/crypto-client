...
const TradingBCH = ({balance}) => {
  ...
  const getTradingData = async () => {
    ...
    let validRate = res.data.ratesData.filter(el => el.coinName === 'BCH')
  ...
  const getInitialChartData = async () => {
    const res = await fetch('https://api.binance.com/api/v3/klines?symbol=BCHUSDT&interval=1m&limit=100')
      ...
      <Row>
        <Col className='col-12 col-xl-9'>
            ...
            <Row>
              <Col className=''>
                <div className='d-flex align-items-center'>
                  <img style={{marginRight: 20}} width={40} src={`/img/bch.svg`} alt=""/>
                  <div className='d-flex align-items-center'>
                    <span style={{fontSize: 28, marginRight: 20}}>Bitcoin Cash</span>
                ...
                <div style={{color: 'grey', fontSize: 16, marginTop: 20}}>Balance: {balance.coinBalance.toFixed(5)} BCH</div>
              </Col>
              <Col>
                <CurrencyPrice />
              </Col>
          ...
          <ButtonCard theme={theme}>
            ...
            {
              rate && initialChartData.length && tradingData ? <Chart initialData={initialChartData} coinName={'BCH'} tradingData={tradingData} rate={Number(rate)} data={data} /> : <Preloader />
            }
          </ButtonCard>
          <Row>
            <ButtonCard theme={theme}>
