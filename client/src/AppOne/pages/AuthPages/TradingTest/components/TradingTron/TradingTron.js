...
const TradingTron = () => {
    ...
    const getOhlc = async () => {
        const res = await fetch('https://api.coingecko.com/api/v3/coins/tether/ohlc?vs_currency=usd&days=1')
        ...
        <Container>
            <Row>
                ...
                <Col className={'col-12 col-md-9'}>
                    <ButtonCard title={`TRX: ${curVal.toFixed(5)} $`}>
                        {/*<Row className={'mb-3'}>*/}
                        {/*    <select style={{*/}
                                            ...
                                            <Row>
                                                ...
                                                <Col>
                                                    <p style={{fontSize: 12}}>Balance is:&nbsp;
                                                        {stateBalance.length
                                                            ? stateBalance.filter(el => el.coinName === 'TRX')[0].coinBalance.toFixed(5)
                                                            : <Preloader />}
                                                    </p>
                                                </Col>
                                            </Row>
...
TradingTron.propTypes = {
    
}
TradingTron.defaultProps = {
    
}

export default TradingTron