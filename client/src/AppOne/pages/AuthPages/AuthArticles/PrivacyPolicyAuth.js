        ...
        <Container>
            <div className="article footer_links_page">
                ...
                <p className="article-text">TThank you for visiting {domain}, a digital asset trading website, which is
                    ...
                    interface
                    (“Site”), you consent to the policies and practices of our privacy policy (the “Privacy Policy”), so
                    please
                    read
                    them carefully. This Privacy Policy explains how {domain} uses your Personal Data (defined below) as
                    we
                    provide you with access and utility through our digital asset Trading Platform via software, API
                    (application
                    program interface), technologies, products and/or functionalities (“Service”). In the course of
                    providing
                    you our
                    Service, to abide by the laws in the jurisdictions that we operate, and to improve our services, we
                    need to
                    collect
                    and maintain personal information about you. As a rule, we never disclose any personal information
                    about our
                    customers to any non-affiliated third parties, except as described below. We may update this Privacy
                    Policy
                    at any
                    time by posting the amended version on this site including the effective date of the amended
                    version. We
                    will
                ...
                <p className="article-text">As used herein, “Virtual Financial Asset” under Germany Virtual Financial
                    Asset
                    Act, 2018, also called “Convertible Virtual Currency,” “cryptocurrency,” or “digital goods”, such as
                    bitcoin
                    or
                ...
                <p className="article-text">{domain} collects, processes, and stores Personal Data collected from you via
                    ...
                    copies
                    of
                    identification documentation provided by you or derived from publicly accessible databases, your
                    government
                    identification number as well as information relating to your device or internet service (such as an
                    IP
                    address and
                    a MAC number).</p>
                <p className="article-text">We collect information you provide during the {domain} onboarding process,
                    which may be
                    a completed, incomplete, or abandoned process. Operating within the European Economic Area (“EEA”),
                    we
                    collect,
                    store, and process your personal information in accordance with the provisions of the General Data
                    Protection
                ...
                <ul className="article-list">
                    ...
                    <li className="article-list__item">
                        Proof of identity (e.g., passport, driver’s license, or government-issued ID) for significant
                        individual
                ...
                <p className="article-text">As outlined above, we may collect Personal Data from customers located in
                    ...
                    the
                    transfer of
                    Personal Data from the EEA to outside of the area. If you are an individual located in the EEA and
                    you
                    decline to
                    consent to such transfer, you will no longer be able to use {domain} and our services. You will have
                    the
                ...
                <p className="article-text">{domain} uses Personal Data to communicate with you and to administer,
                    ...
                    relation to
                    other
                    products or services offered by {domain} and/or its partners. We do not share your Personal Data with
                    third
                    parties (other than partners in connection with their services to {domain}) except where you have
                    given your
                ...
                <p className="article-text">To comply with government agencies, including regulators, law enforcement
                    ...
                    justice
                    departments;</p>
                <p className="article-text">To third parties who provide services to {domain} (such as administration or
                    technical
                    services);</p>
                <p className="article-text">In connection with the sale or transfer of our business or any part
                    thereof.</p>
                <p className="article-text">Additionally, we have implemented international standards to prevent money
                    ...
                    Virtual
                    Financial
                    Asset rules and regulations when effective, which will likely require us to undertake due diligence
                    on our
                ...
                <p className="article-text">The data that we collect from you may be transferred to, and stored at, a
                    destination
                    outside
                    of Germany. It may also be processed by staff operating outside of Germany who work
                    for us
                    or for one of our suppliers. By submitting your personal data, you agree to this transfer, storing
                    or
                    processing,
                    except customers located in the EEA, as detailed above. All information you provide to us is stored
                    on our
                    and/or
                ...
                <p className="article-text">You have the right to obtain a copy of your Personal Data upon request and
                    ...
                    inaccurate,
                    you may
                    request to update your information. You may also request to delete your Personal Data, with
                    exception that
                    we may
                    refuse your deletion request in certain circumstances, such as compliance with law or legal
                    purposes. For
                    data
                    access, correction, or deletion requests, please contact support@{domainFull} with the subject “DATA
                    INQUIRY”.
                </p>
                <p className="article-text">In response to data access, correction, or deletion request, we will verify
                    the
                    requesting
                    party’s identity to ensure that he or she is legally entitled to make such request. While we aim to
                    respond
                    to these
                    requests free of charge, we reserve the right to charge you a reasonable fee should your request be
                    repetitive or
                    onerous.</p>
                ...
                <p className="article-text">We may communicate company news, promotions, and information relating to our
                    products
                    and
                    services provided by {domain}. We may share Personal Data with third parties to help us with our
                    marketing
                    and promotional projects, or sending marketing communications. By using {domain}, you accept this
                    Privacy
                    Policy and you agree to receive such marketing communications.</p>
                <p className="article-text">Customers can opt out of these marketing communications at any moment. If
                    you do not
                    want to
                    receive these communications, please send an email to support@{domainFull}</p>
                ...
                <p className="article-text">We endeavor to protect {domain} and you from unauthorized access, alteration,
                    ...
                    information
                    security, including encryption of the {domain} communications with SSL; required two-factor
                    authentication
                    for all sessions; periodic review of our Personal Data collection, storage, and processing
                    practices; and
                    restricted
                    access to your Personal Data on a need-to-know bases for our employees and vendors who are subject
                    to strict
...
PrivacyPolicyAuth.propTypes = {
    
}
PrivacyPolicyAuth.defaultProps = {
    
}

export default PrivacyPolicyAuth