...
export default class AuthService {
    ...
    static async registration(email, password, name, domain_name, datetime, promocode = 'empty') {
        return $api.post('/registration', {email, password, name, domain_name, datetime, promocode})
    }
